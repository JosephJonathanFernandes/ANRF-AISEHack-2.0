...
submission.to_csv('outputs/submission_v15.csv', index=False)
print('\noutputs/submission_v15.csv saved.')
...
plt.suptitle(f'v15 OOF Predicted vs Actual  |  Mean R² = {(r2_tg+r2_egc)/2:.4f}', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig('outputs/oof_scatter_v15.png', dpi=120, bbox_inches='tight')
print('Plot saved as outputs/oof_scatter_v15.png.')

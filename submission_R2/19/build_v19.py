"""
build_v19.py — v14 + CatBoost + XGBoost + Stage A NNLS blend + Pseudo-Labeling
"""
import json, os

IN  = r"C:\Users\Joseph\Desktop\projects\ANRF-AISEHack-2.0\submission_R2\Shivesh\anrf-app3.ipynb"
OUT = r"C:\Users\Joseph\Desktop\projects\ANRF-AISEHack-2.0\submission_R2\19\anrf-v19.ipynb"
...
for cell in nb["cells"]:
    ...
    # ── Stage B Mega Zoo & Pseudo-Labeling ───────────────────────────────────────
    if not zoo_done and "def stage_b_models" in src_joined:
        # We replace the whole cell with our custom mega zoo + PL

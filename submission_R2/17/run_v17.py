"""
run_v17.py — NB03 + N_AUG=8 + ExtraTrees + XGBoost + Stage A NNLS blend
No GPU required. CPU runtime ~50-60 min.

Usage:
  python submission_R2/17/run_v17.py
"""
import json, subprocess, sys, os

NOTEBOOK = os.path.join(os.path.dirname(os.path.abspath(__file__)), "anrf-v17.ipynb")

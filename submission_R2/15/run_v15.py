"""
run_v15.py — Run v15 locally (GPU strongly recommended for Stage A NN).

Usage:
  python submission_R2/15/run_v15.py
"""
import json, subprocess, sys, os

NOTEBOOK = os.path.join(os.path.dirname(os.path.abspath(__file__)), "anrf-v15.ipynb")
...
if __name__ == "__main__":
    ...
    print("GPU will be used if available (strongly recommended for Stage A NN)\n")

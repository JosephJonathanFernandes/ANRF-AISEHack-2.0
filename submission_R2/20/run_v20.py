"""
run_v20.py — Mega Zoo (LGB+Ridge+ET+XGB+CatBoost) + NNLS Stage A (NO Pseudo-Labeling)
"""
import json, subprocess, sys, os

NOTEBOOK = os.path.join(os.path.dirname(os.path.abspath(__file__)), "anrf-v20.ipynb")
